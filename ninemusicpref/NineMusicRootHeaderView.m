#import "NineMusicRootHeaderView.h"
#import <Preferences/PSSpecifier.h>

@implementation NineMusicRootHeaderView

- (instancetype)initWithSpecifier:(PSSpecifier*)specifier {
	self = [super init];

	UIImage* headerImage = [UIImage imageNamed:@"NineMusicBanner" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
